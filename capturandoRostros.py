...
dataPath = 'C:/Users/Melissa/Desktop/EMOIA/Data' #ruta del Data
...
while True:
	...
	k =  cv2.waitKey(1)
	if k == 27 or count >= 200: # Se toman en cuenta doscientos frames del video capturado por la webcam para hacer el analisis 
		break
